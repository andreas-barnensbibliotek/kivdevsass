...
jQuery(function ($){
    ...
    $(document).on('click', '.showingresstext', function (e) {
        ...
        if (thatobj.length <= 0) {           
            ...
            //rensa bort absolut v�rdet fr�n stringen
            ...
            // h�mta f�rsta delen av style f�r s�kning senare
            ...
            //rensa bort position: relative; v�rdet fr�n stringen
        ...
        if (addOrRemove) {
            ...
            valdclass.html('<img src="http://dev.kulturivast.se.www359.your-server.de/sites/all/themes/kivnew/images/iconkryss.png" alt="D�lj" />');
    ...
    // scrollar ner fr�n artikelmenyn till artikel ancor
